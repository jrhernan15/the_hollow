...
const PARLOUR_GAMES = ["confession", "fork", "usual", "usualsuspect"];
...
function loadParlourPrompts() {
  const out = { confession: { tame: [], spicy: [], raunchy: [] }, fork: { tame: [], spicy: [], raunchy: [] }, usual: { tame: [], spicy: [], raunchy: [] }, usualsuspect: { tame: [], spicy: [], raunchy: [] } };
  try {
